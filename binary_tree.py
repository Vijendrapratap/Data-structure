"""
This is a program of binary tree data structure. in binary tree there is a parent node and two child nodes left and right
any data smaller than root node save on the left side and bigger values save on the right side.
...
#creating a node class for entry of data in binary tree
class Node(object):
